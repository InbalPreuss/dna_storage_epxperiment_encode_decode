...
def build_config(
    ...
    config = {
        ...
        'decoder_results_file_z_before_rs_payload': output_dir / 'simulation_data.7.decoder_results_file_z_before_rs_payload.dna',
        'decoder_results_file_z_after_rs_payload': output_dir / 'simulation_data.8.decoder_results_file_z_after_rs_payload.dna',
        'decoder_results_file_z_after_rs_wide': output_dir / 'simulation_data.9.decoder_results_file_z_after_rs_wide.dna',
        'decoder_results_file': output_dir / 'simulation_data.10.decoder_results_file.dna',
        'binary_results_file': output_dir / 'simulation_data.11.binary_results_file.dna',
        'text_results_file': output_dir / 'simulation_data.12.text_results_file.dna',

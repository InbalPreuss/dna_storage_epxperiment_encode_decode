...
def compute_sigma_distance(config: Dict):
    ...
    dist_sigma_after_rs_wide = 0
    return dist_sigma_before_rs, dist_sigma_after_rs_payload, dist_sigma_after_rs_wide, len(input_data_encoder_results_file), len(input_data_encoder_without_rs_payload), 0
...
def run_config(config_for_run: Dict, run_number):
    ...
    input_text = output_dir + '/random_file_1_KiB.txt'
